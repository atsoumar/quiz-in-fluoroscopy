...
const questions = [
...

    {
        ...
        optionC: "As Low As Reasonably Achievable.",
        optionD: "As Low As Reasonably Attenuated.",
        correctOption: "optionC",
        explanation:"The dose must be as low as reasonably achievable, while we keeping the benefit from the diagnostic procedure."
    },
    ...
    {
        question: "Which of the following is true regarding the production of X-ray photons when using a tungsten target?",
